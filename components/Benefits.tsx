...
export const Benefits: React.FC = () => {
  return (
    <section id="benefits" className="py-24 bg-optarix-blue text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <Reveal>
            <h2 className="text-3xl md:text-5xl font-heading font-bold mb-6">Unlock <span className="text-optarix-cyan">12X</span> More Quality Talent</h2>
            <p className="text-gray-300 text-lg">
              Optarix Research provides measurable outcomes that fundamentally improve your recruitment ROI.
              Efficiency gains without sacrificing the quality necessary for long-term success.
            </p>
          </Reveal>
        </div>
            ...
            <Reveal key={index} delay={index * 100}>
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors duration-300 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="text-optarix-cyan font-semibold text-sm uppercase tracking-wider mb-2">{stat.label}</div>
        ...
        <div className="mt-16 flex justify-center">
            <Reveal delay={600}>
              <div className="bg-white/10 rounded-2xl p-8 max-w-4xl mx-auto backdrop-blur-sm border border-white/10">
                  <h3 className="text-2xl font-bold mb-4 text-center">Long-Term Value</h3>
                  <p className="text-gray-300 text-center">
                    Clients report an average retention for permanent hires standing at <span className="text-white font-bold text-xl">4.3 years</span>.
                    This success is rooted in our AI-human collaboration partnership.
                  </p>
              </div>
            </Reveal>
        </div>
